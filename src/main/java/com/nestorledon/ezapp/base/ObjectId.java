...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    private static final String TAG = ObjectId.class.getCanonicalName();
    ...
    private static int createMachineIdentifier() {
        ...
        try {
            ...
            Log.e(TAG, "Failed to get machine identifier from network interface, using random number instead", t);
        }
    ...
    private static short createProcessIdentifier() {
        ...
        try {
            ...
            //} else {
                processId = (short) (22222);
            //}

        } catch (Throwable t) {
            processId = (short) new SecureRandom().nextInt();
            Log.e(TAG, "Failed to get process identifier from JMX, using random number instead", t);
        }
